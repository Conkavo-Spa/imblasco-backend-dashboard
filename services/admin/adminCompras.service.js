...
export default class AdminComprasService {
    ...
    getProductos = async () => {
        ...
        const aPedir = conCobertura.filter(p => {
            ...
            // Requiere actividad en el año actual o el anterior — confirma que el producto sigue en el catálogo activo
        ...
        // Sort: productos con actividad en el año actual primero, luego todos por urgencia (mesesCobertura asc).
        // Sin tiers: todos los productos restantes tienen actividad en cy o cy-1.
        aPedir.sort((a, b) => {
