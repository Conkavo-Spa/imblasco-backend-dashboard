...
async function main() {
    ...
    // ── Catálogo completo (para búsqueda) ─────────────────────────────────────
    // Incluye todos los productos con ventas + productos con stock pero sin ventas recientes
    const catalogo = [...ordenados];
    ...
    console.log(`   Catálogo completo: ${CATALOG_PATH} (${catalogo.length} productos)`);
